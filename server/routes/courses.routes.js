...
import { courseinfo, deleteCourse, getAllCourses ,getFeaturedCourses, postCourse, putCourse, getCoursesForBuilder} from "../controllers/courses.controller.js"
...
router.get("/builder",getUserInfo,notStudent,getCoursesForBuilder)
// featured Courses
